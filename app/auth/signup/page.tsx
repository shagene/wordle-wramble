  ...
  if (showVerificationMessage) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full max-w-md text-center z-10 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg animate-in fade-in">
          ...
          <Button 
            href="/auth/login" 
            className="bg-gradient-to-r from-blue-400 to-purple-500 text-white font-[family-name:var(--font-bubblegum-sans)] rounded-xl py-3 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
            Back to Sign In
          </Button>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="mt-6 text-center">
            <Text className="text-sm">
              ...
              <Button plain href="/auth/login" className="inline-flex items-center gap-1 font-medium text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">
                Sign in
